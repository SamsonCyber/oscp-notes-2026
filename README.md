...
|---------|----------------|
| **Port → note map** | Service open? Open the matching note. No hunting a 400-page PDF. |
| **I'm Stuck trees** | Decision trees for “no vector”, “creds but no shell”, “shell but no root”. |
